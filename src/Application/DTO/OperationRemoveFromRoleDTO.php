...
class OperationRemoveFromRoleDTO
{
    use DTOTrait;
    ...
    public function setOperation(string $operation): OperationRemoveFromRoleDTO
    {
    ...
    public function setRoleId(int $roleId): OperationRemoveFromRoleDTO
    {
        $this->roleId = $roleId;
        return $this;
    }
