...
class RoleRemoveFromUserDTOName
{
    use DTOTrait;
    ...
    public function setUserId(int $userId): RoleRemoveFromUserDTOName
    {
        $this->userId = $userId;
        return $this;
    }
    ...
    public function setRoleName(string $roleName): RoleRemoveFromUserDTOName
    {
