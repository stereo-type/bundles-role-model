...
/**
 * @template RoleAssignToUserDTO
 * @template User
 * @implements ProcessorInterface<RoleAssignToUserDTO, User>
 */
readonly class RoleAssignToUserProcessor implements ProcessorInterface
{
    ...
    /**
     * @param RoleAssignToUserDTO $data
